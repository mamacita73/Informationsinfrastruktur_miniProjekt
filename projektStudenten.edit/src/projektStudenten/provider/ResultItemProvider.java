...
/**
 * This is the item provider adapter for a {@link projektStudenten.Result} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ResultItemProvider 
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Result_key_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Result_key_feature", "_UI_Result_type"),
				 ProjektStudentenPackage.Literals.RESULT__KEY,
				 true,
				 false,
				 true,
				 null,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 ProjektStudentenPackage.Literals.RESULT__VALUE,
				 true,
				 false,
				 false,
	...
	public String getText(Object object) {
		Grade labelValue = ((Result)object).getValue();
